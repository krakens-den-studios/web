...
export default function HeartWeaver() {
  ...
  return (
    <main className="w-full">
      ...
      <section
        className="relative w-full h-fit gap-4 bg-purple grid md:grid-areas-left md:grid-cols-left items-center justify-items-center pt-8 md:pt-0"
        id="game"
      >
      ...
      <section className="relative w-full h-fit gap-4 grid md:grid-areas-right md:grid-cols-right items-center justify-items-center pt-8 md:pt-0">
        <div className="relative flex flex-col gap-6 items-center md:items-start md:grid-in-story w-fit md:pl-8">
      ...
      <section className="relative w-full h-fit gap-4 bg-purple grid md:grid-areas-left md:grid-cols-left items-center justify-items-center pt-8 md:pt-0">
        <div className="relative flex flex-col gap-6 items-center md:items-start md:grid-in-story w-fit">
