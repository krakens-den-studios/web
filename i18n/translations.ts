  ...
  en: {
    ...
    gameData: {
      ...
      missions: {
        ...
        'own-10-helpers': { name: "We're a family", description: 'Get {n} different helpers working at the same time.' },
  ...
  es: {
    ...
    gameData: {
      ...
      missions: {
        ...
        'own-10-helpers': { name: 'Somos una familia', description: 'Consigue {n} ayudantes diferentes trabajando al mismo tiempo.' },
  ...
  ca: {
    ...
    gameData: {
      ...
      missions: {
        ...
        'own-10-helpers': { name: 'Som una família', description: 'Consegueix {n} ajudants diferents treballant al mateix temps.' },
